                ...
                <form action="/register" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        if ($session->getFlashdata('errorNama')) {
                            echo '<div class="alert alert-danger">' . $session->getFlashdata('errorNama') . '</div>';
                        }
                        ?>
                    ...
                    <div class="mb-3">
                        ...
                        if ($session->getFlashdata('errorUsername')) {
                            echo '<div class="alert alert-danger">' . $session->getFlashdata('errorUsername') . '</div>';
                        }
                        ?>
                    ...
                    <div class="mb-3">
                        ...
                        if ($session->getFlashdata('errorEmail')) {
                            echo '<div class="alert alert-danger">' . $session->getFlashdata('errorEmail') . '</div>';
                        }
                        ?>
                    ...
                    <div class="mb-3">
                        ...
                        if ($session->getFlashdata('errorPassword')) {
                            echo '<div class="alert alert-danger">' . $session->getFlashdata('errorPassword') . '</div>';
                        }
                        ?>
                    ...
                    <div class="mb-3">
                        ...
                        if ($session->getFlashdata('errorPasswordConf')) {
                            echo '<div class="alert alert-danger">' . $session->getFlashdata('errorPasswordConf') . '</div>';
                        }
                        ?>
